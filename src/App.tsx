          ...
          <div className="min-h-screen bg-zinc-950 text-zinc-50 flex flex-col relative overflow-hidden">
            ...
            <header className="px-8 py-6 flex justify-between items-center max-w-7xl mx-auto w-full backdrop-blur-sm sticky top-0 z-10">
              ...
              <nav className="flex items-center gap-8">
                <Link to="/login" className="text-sm font-semibold text-zinc-400 hover:text-white transition-colors">Login</Link>
                <Link to="/signup" className="px-5 py-2 bg-white text-zinc-950 rounded-full text-sm font-bold hover:bg-zinc-200 transition-all active:scale-95">Sign Up</Link>
              </nav>
            </header>
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-6 relative">
              <div className="max-w-4xl mx-auto text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-8">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-indigo-400">Personal Broadcast System</span>
                </div>
            ...
            <footer className="p-8 text-center border-t border-zinc-900/50">
              <p className="text-zinc-600 text-sm font-medium">&copy; 2026 Personal Broadcast System. All rights reserved.</p>
            </footer>
          </div>
        } />
